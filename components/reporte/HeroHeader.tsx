    ...
    <>
      ...
      >
        <div className="mx-auto max-w-6xl px-4 sm:px-6 py-8 sm:py-10">
          ...
          <div className="flex items-center gap-4 mb-6">
            <img src="/logo-innovando.png" alt="Innovando" className="h-6 w-6 shrink-0 opacity-40 dark:opacity-20" />
      ...
      >
        <div className="mx-auto max-w-6xl px-4 sm:px-6 h-full flex items-center gap-3">
          ...
          >
            <img src="/logo-innovando.png" alt="Innovando" className="h-6 w-6 opacity-40 dark:opacity-20" />
          </button>
